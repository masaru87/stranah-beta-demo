...
// プロジェクト固有のメンバー（外部開発者含む）
const initialProjectMembers: Member[] = [
  {
    id: "pm-1",
    user: {
      id: "user-1",
  ...
  },
  {
    ...
    user: {
      id: "user-7",
      name: "中村 花子",
      email: "nakamura@partner.co.jp",
      company: "パートナー企業",
    },
    role: "member",
    status: "invited",
    invitedAt: "2026-03-27T14:00:00Z",
  },
];
...
export default function ProjectMemberPage() {
  ...
  const [members, setMembers] = useState<Member[]>(initialProjectMembers);
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {project?.name ?? "プロジェクト"} — {members.length} 名
            </p>
          </div>
        </div>
        <Dialog open={inviteOpen} onOpenChange={setInviteOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>プロジェクトメンバーを招待</DialogTitle>
              <DialogDescription>
                外部開発者もプロジェクト単位で招待できます
              </DialogDescription>
            </DialogHeader>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {member.user.email}
                      {member.user.company && (
                        <span className="ml-1">({member.user.company})</span>
                      )}
                    </p>
                  </div>
                </div>
